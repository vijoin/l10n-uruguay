...
class grpSiceColor(models.Model):

    # Atributos privados
    _name = 'grp.sice_color'
    _rec_name = 'descripcion'
    _description = u'Color del artículo SICE'

    # Declaración de campos
    # Campos SICE
    cod = fields.Integer(string=u'Código de color', required=True, index=True)
    ...
    # Restricciones SQL
    _sql_constraints = [
        ("unique_sice_color_cod", "unique(cod)", u"Ya existe un color con el mismo código"),
    ]
