...
denom = ('',
         ...
         'CUATRILLÓN', 'MIL CUATRILLONES', 'QUINTILLÓN', 'MIL QUINTILLONES', 'SEXTILLÓN', 'MIL SEXTILLONES',
         'SEPTILLÓN',
...
denom_plural = ('',
                ...
                'MIL SEXTILLONES', 'SEPTILLONES',
                'MIL SEPTILLONES', 'OCTILLONES', 'MIL OCTILLONES', 'NONILLONES', 'MIL NONILLONES', 'DECILLONES',
                'MIL DECILLONES')
...
def amount_to_text_es(number, currency):
    ...
    cents_name = ''
    if units_name == '':
        cents_name = (cents_number > 1) and 'CENTÉSIMOS' or 'CENTÉSIMO'
    else:
