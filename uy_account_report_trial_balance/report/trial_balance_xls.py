...
from openerp.addons.account_financial_report_webkit_xls.report.trial_balance_xls \
    import trial_balance_xls
from .trial_balance import TrialBalanceWebkitExt
from utils import compute_amounts_in_currency


class trial_balance_xls_ext(trial_balance_xls):
...
trial_balance_xls_ext( 'report.account.account_report_trial_balance_xls_ext',
                       'account.account',
