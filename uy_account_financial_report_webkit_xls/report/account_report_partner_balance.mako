    ...
    <body>
        ...
        <div class="act_as_table data_table">
            <div class="act_as_row labels">
                ...
                <div class="act_as_cell">${_('Año Fiscal')}</div>
                ...
                <div class="act_as_cell">${_('Filtro Cuenta')}</div>
            ...
            <div class="act_as_table data_table">
                <div class="act_as_row">
                    ...
                    <div class="act_as_cell">
                        ...
                        %else:
                            ${_('Año Fiscal :')}&nbsp;${params['fiscalyear'].name}
                        %endif
                    </div>
                    <div class="act_as_cell">${ _('Balance Inicial:')} ${ initial_balance_text[params['initial_balance_mode']] }</div>
                </div>
            </div>
        %endfor
